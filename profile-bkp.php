<?php 
    ...
    if (isset($_POST['submit_note'])) {
        ...
        mysqli_query($con, "INSERT INTO daily_record VALUES ('','$patient','$posted_by','$category','$date_time','$note')") or die(mysqli_error($con));
                                            ...
                                            <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                                                <div class="note-top">
                                                    <!-- <form action="" method="POST" class="gen-form">
                                                        <div class="row"> -->
                                                            <!-- <div class="col-md-8">
                                                                <input type="textarea" id="note" name="notes" value="" placeholder="Add a note...">
                                                            </div> -->
                                                            <!-- <div class="col-md-4">
                                                                <select name="category" id="category" class="notes-category">
                                                                    <option value="Daily Record" selected>Daily Record</option>
                                                                    <option value="AHP">AHP</option>
                                                                    <option value="Fitness Instructors">Fitness Instructors</option>
                                                                    <option value="HCA">HCA</option>
                                                                ...
                                                                <input type="hidden" name="posted_by" value="<?php echo $userLoggedIn; ?>">
                                                                <input type="hidden" name="patient" value="<?php echo $username; ?>">
                                                                <input type="submit" value="Submit" id="submit" name="submit_note">
                                                            </div> -->
                                                        <!-- </div>
                                                    </form> -->
                                                    <div class="row note-search-fields">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" id="view-general-notes-cat" name="view-general-notes-cat" placeholder="View category...">
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="text" id="sort-general-notes-date" name="sprt-general-notes-date" placeholder="Sort by date...">
                                                        </div>  
                                                        <div class="col-md-3">
                                                            <input type="text" class="note-btn" name="sprt-general-notes-date" placeholder="+ Add Note">
                                                        </div>                           
                                                    </div>
                                                </div>
                                                    <?php

                                                    $query = mysqli_query($con, "SELECT * FROM daily_record WHERE patient='$username' ORDER BY date_time DESC") or die(mysqli_error($con));
                                                    ...
                                                    <div class="row patient-note">
                                                        <div class="col-3 col-md-4">
                                                            ...
                                                            <strong><a href="<?php echo $row['posted_by']; ?>" class="dr-patient-note"><?php echo $dr_name; ?></a></strong><br />
                                                    ...
                                                    <?php } ?>
<!--                                                     <div class="row patient-note">
                                                        <div class="col-3 col-md-4"> <img src="https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" style="width: 50px; height: 50px; border-radius: 100%;"> <strong>Alex Davenport</strong>
                                                            <br /> <span>01/03/2022 09:30</span>
                                                            <br />
                                                            <div class="note-category">Phyical Therapy</div>
                                                        </div>
                                                        <div class="col-9 col-md-8">
                                                            <p>Patient presented with lower back pain and stiffness, and difficulty walking. Sharp shooting style pain in the left leg occasionally.</p>
                                                            <p>Assessment of the patient indicates sciatica, though further tests have been ordered. Pain and tightness eased with massage, and recommended some light exercises in the interim. Pain killers also suggested.</p>
                                                            <p>Referred back to GP for stronger pain medication.</p>
                                                        </div>
                                                    </div>
                                                    <div class="row patient-note">
                                                        <div class="col-3 col-md-4"> <img src="assets/images/profile_pics/devan.jpg" style="width: 50px; height: 50px; border-radius: 100%;"> <strong>Dr. Devan Moodley</strong>
                                                            <br /> <span>28/02/2022 10:40</span>
                                                            <br />
                                                            <div class="note-category">Mental Health</div>
                                                        </div>
                                                        <div class="col-9 col-md-8">
                                                            <p>Assessment conducted for John Doe, due to low mood, irritability, and lack of motivation.</p>
                                                            <p>Patient also describes inability to sleep, and always being tired. Full report attached. Patient has signs of stress and depression. Referred to the psychiatrist team.</p>
                                                        </div>
                                                    </div>
                                                    <div class="row patient-note">
                                                        <div class="col-3 col-md-4"> <img src="https://cdn.pixabay.com/photo/2017/10/10/00/49/female-2835524_1280.jpg" style="width: 50px; height: 50px; border-radius: 100%;"> <strong>Cressida Roberts</strong>
                                                            <br /> <span>25/02/2022 14:10</span>
                                                            <br />
                                                            <div class="note-category">Optical</div>
                                                        </div>
                                                        <div class="col-9 col-md-8">
                                                            <p>Annual optical test. Current prescription client says isn't strong enough for distance.</p>
                                                            <p>Eye health test - healthy</p>
                                                    ...
                                                    <div class="row patient-note">
                                                        <div class="col-3 col-md-4"> <img src="https://cdn.pixabay.com/photo/2013/11/14/13/11/indian-210382_960_720.jpg" style="width: 50px; height: 50px; border-radius: 100%;"> <strong>Dr. Ahmed Patel</strong>
                                                            <br /> <span>22/02/2022 07:00</span>
                                                            <br />
                                                            <div class="note-category">Emergency</div>
                                                        </div>
                                                        <div class="col-9 col-md-8">
                                                            <p>Patient brought to A&E after falling from a horse (direct impact on head). Presents with moderate concussion with slight head and neck ache, and a little confused. BP 120/80 and other vital signs normal.</p>
                                                            <p>Patient admitted for the night for observation.</p>
                                                        </div>
                                                    </div> -->
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="initialassessment" role="tabpanel" aria-labelledby="initialassessment-tab">
                                                ...
                                                <?php require_once 'includes/form_handlers/referral-assessment.php'; ?>
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="riskassessments" role="tabpanel" aria-labelledby="riskassessments-tab">
                                                ...
                                                <select id="selectRiskAssessment">
                                                    ...
                                                    <option value="Activity Risk Assessment">Activity Risk Assessment</option>
                                                    ...
                                                    <option value="The Fallowfield Supported Living Service - Pre-admission Assessment (template)">The Fallowfield Supported Living Service - Pre-admission Assessment (template)</option>
                                                </select>
                                                or
                                                <a class="main-button" href="form.php?type=Risk%20Assessment">Use Form Builder</a>
                                                    <div id="option1" class="riskAssessmentContentArea">
                                                    <h1>Option 1</h1>
                                                    <p>Content block 1</p>
                                                    </div>
                                                    <div id="option2" class="riskAssessmentContentArea">
                                                    <h1>Content 2</h1>
                                                    <p>Content block 2</p>
                                                    </div>
                                                    <div id="option3" class="riskAssessmentContentArea">
                                                    <h1>Content 3</h1>
                                                    <p>Content block 3</p>
                                                    </div>
                                                    <script>
                                            ...
                                            <h4>Section 17 - Leave of Absence Record<br></h4>
                                        ...
                                        <form method="POST" action="">
                                            ...
                                            Note: <textarea name="tooth_note" id="tooth_note" cols="30" rows="10"></textarea>
                                            <button type="submit" name="submit_tooth_note">Submit</button>
                                        </form>
                                        <script>
                                        var doc = $(document);
                                                doc
