...
<head>
	...
	<title>Register | Collaborate</title>
		...
		<div class="login_box">
				...
				<div class="row">
					<div class="col-lg-6">
						<form action="register.php" method="POST">
							...
							<a href="register1.php" id="signup" class="signup">Need an account? <span>Register here!</span></a>
						</form>
					</div>
					<div class="col-lg-6">
			...
			<div id="second">
				<form action="register.php" method="POST">
					...
					<a href="register1.php" id="signin" class="signin">Already have an account? Sign in here!</a>
				</form>		
			</div>
		</div>	
	</div>
