...
if(isset($_GET['id'])) {
    ...
    if ($row['project_type'] == "public_project")
        $project_type = "Public Project";
    if ($row['project_type'] == "private_project")
        $project_type = "Private Project";
    if ($row['project_type'] == "hidden_project")
        $project_type = "Hidden Project";
    ...
    <div class="container">
        <div class="row">                                           
            <div class="pro-banner">
                <img src="<?php echo $row['project_banner']; ?>" class="img-fluid">
            </div>
            <div class="pro-img">
                <img src="/assets/images/profile_pics/pro-img.png" class="img-fluid">
            </div>
            <div class="pro-title text-center">
                <h2><?php echo $project_name; ?> <span><?php echo $project_type; ?></span></h2>
                <!-- <p>Strategy, action plans and application</p> -->
            </div>
        </div>
    </div>
</section>
...
<section class="project-tab">
    <div class="row">
        <ul class="nav tab-menu-project" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="button-4 active" id="feed-tab" data-bs-toggle="tab" data-bs-target="#feed" type="button" role="tab" aria-controls="feed" aria-selected="false">Feed</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="button-4" id="documents-tab" data-bs-toggle="tab" data-bs-target="#documents" type="button" role="tab" aria-controls="documents" aria-selected="false">Documents</button>
            </li>                                  
            <li class="nav-item" role="presentation">
                <button class="button-4" id="projects-tab" data-bs-toggle="tab" data-bs-target="#projects" type="button" role="tab" aria-controls="projects" aria-selected="false">Projects</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="button-4" id="members-tab" data-bs-toggle="tab" data-bs-target="#members" type="button" role="tab" aria-controls="members" aria-selected="false">Members</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="button-4" id="discussions-tab" data-bs-toggle="tab" data-bs-target="#discussions" type="button" role="tab" aria-controls="discussions" aria-selected="false">Discussions</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="button-4" id="invites-tab" data-bs-toggle="tab" data-bs-target="#invites" type="button" role="tab" aria-controls="invites" aria-selected="false">Send Invites</button>
            </li>
        </ul>
        ...
        <div class="tab-pane fade" id="discussions" role="tabpanel" aria-labelledby="discussions-tab">Discussion</div>
        <div class="tab-pane fade" id="invites" role="tabpanel" aria-labelledby="invites-tab">Invites</div>                       
    </div>
</div>
                            ...
                            <div class="tab-container" id="tab12C">
                                <div class="top-bar-projects">
                                    <div class=" wrapper-search-project">
                                        <input type="text" id="myFilterTwo" class="search-service" onkeyup="myFunctionTwo()" placeholder="Search for a project...">
                                    </div>
                                    <div>
